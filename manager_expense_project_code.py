...
e1 = Expense("durai", 1, 200, "dress", "food", "2026-04-01")
e1.add_expense()

e2 = Expense("durai", 1, 500, "Travel", "Bus Ticket", "2026-04-02")
e2.add_expense()

e3 = Expense("durai", 1, 1000, "Shopping", "Shoes", "2026-04-03")
e3.add_expense()

e4 = Expense("durai", 1, 300, "Food", "Dinner", "2026-04-05")
e4.add_expense()
